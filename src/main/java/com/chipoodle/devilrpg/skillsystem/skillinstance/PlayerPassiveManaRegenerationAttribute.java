...
public class PlayerPassiveManaRegenerationAttribute extends AbstractPlayerPassiveAttribute implements ISkillContainer {
    ...
    public PlayerPassiveManaRegenerationAttribute(PlayerSkillCapabilityImplementation parentCapability) {
