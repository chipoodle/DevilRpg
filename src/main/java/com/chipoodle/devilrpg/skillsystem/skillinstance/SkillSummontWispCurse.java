...
public class SkillSummontWispCurse extends AbstractSkillContainer implements IWispSkill {
    ...
    private SoulWisp summonWisp(Level levelIn, Player playerIn, Random rand) {
        ...
        Objects.requireNonNull(sw).updateLevel(playerIn, MobEffects.POISON, MobEffects.GLOWING, SkillEnum.SUMMON_WISP_CURSE, false);
