...
public class SkillSummonWispChopper extends AbstractSkillExecutor implements IWispSkill {
    ...
    private SoulWisp summonWisp(Level levelIn, Player playerIn, Random rand) {
        ...
        SoulWispChopper sw = ModEntities.WISP_CHOPPER.get().create((ServerLevel) levelIn, null, null, blockPos, MobSpawnType.MOB_SUMMONED, true, true);
