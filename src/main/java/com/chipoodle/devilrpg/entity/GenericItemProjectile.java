...
public class GenericItemProjectile extends ThrowableItemProjectile implements ISoulEntity {
    private float damage = 0;
    public GenericItemProjectile(EntityType<? extends GenericItemProjectile> p_i50159_1_, Level p_i50159_2_) {
        super(p_i50159_1_, p_i50159_2_);
    }

    public GenericItemProjectile(Level levelIn, LivingEntity throwerIn) {
        super(ModEntities.GENERIC_ITEM_PROJECTILE.get(), throwerIn, levelIn);
    }
