...
public class WerewolfItemInHandRenderer {
    ...
    private void renderPlayerArm(PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, float p_109350_, float p_109351_, HumanoidArm humanoidArm) {
        ...
        poseStack.translate(f * (f2 + 0.64000005F), f3 - 0.6F + p_109350_ * -0.6F, f4 - 0.71999997F);
        ...
        if (flag) {
            ...
            werewolfRenderer.renderLeftHand(poseStack, multiBufferSource, packedLight, abstractclientplayer);
        }
