...
public class SoulWispArcherRenderer extends MobRenderer<SoulWispArcher, SoulWispModel<SoulWispArcher>>  {
	...
	public static final ResourceLocation ALLAY_TEXTURE = ResourceLocation.fromNamespaceAndPath(DevilRpg.MODID, "textures/entity/soulwisp/allay_blue.png");
	...
	@Override
	public @NotNull ResourceLocation getTextureLocation(@NotNull SoulWispArcher p_234558_) {
		return ALLAY_TEXTURE;
	}

	protected int getBlockLightLevel(@NotNull SoulWispArcher p_234560_, @NotNull BlockPos p_234561_) {
		return 1;
	}
}
