...
public class WerewolfRenderer extends LivingRenderer<PlayerEntity, WerewolfTransformedModel<PlayerEntity>> {
	...
	private final ResourceLocation werewolfTexture = new ResourceLocation(DevilRpg.MODID + ":textures/entity/werewolf/fire_werewolf.png");
	...
	public void render(PlayerEntity entityIn, float entityYaw, float partialTicks,
	...
	private static BipedModel.ArmPose func_241741_a_(PlayerEntity p_241741_0_, Hand p_241741_1_) {
	...
	protected void renderName(PlayerEntity entityIn, ITextComponent displayNameIn,
			MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
	...
	/*private void renderItem(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn,
			PlayerEntity playerIn, ModelRenderer rendererArmIn, ModelRenderer rendererArmwearIn) {
		WerewolfTransformedModel<PlayerEntity> playermodel = this.getEntityModel();
		...
		rendererArmIn.render(matrixStackIn, bufferIn.getBuffer(RenderType.getEntitySolid(((AbstractClientPlayerEntity) playerIn).getLocationSkin())),
				combinedLightIn, OverlayTexture.NO_OVERLAY);
		rendererArmwearIn.rotateAngleX = 0.0F;
		rendererArmwearIn.render(matrixStackIn,
				bufferIn.getBuffer(RenderType.getEntityTranslucent(((AbstractClientPlayerEntity) playerIn).getLocationSkin())), combinedLightIn,
