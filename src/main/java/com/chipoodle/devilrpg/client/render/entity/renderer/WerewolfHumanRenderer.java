...
@OnlyIn(Dist.CLIENT)
public class WerewolfHumanRenderer extends LivingEntityRenderer<AbstractClientPlayer, WerewolfHumanModel<AbstractClientPlayer>> {
   public WerewolfHumanRenderer(EntityRendererProvider.Context p_174557_, boolean p_174558_) {
