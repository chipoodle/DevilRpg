...
public abstract class StuckInBodyWerewolfLayer<T extends LivingEntity, M extends WerewolfTransformedModel<T>>
	...
	protected abstract void func_225632_a_(MatrixStack p_225632_1_, IRenderTypeBuffer p_225632_2_, int p_225632_3_,
	...
	public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn,
		...
		if (i > 0) {
			for (int j = 0; j < i; ++j) {
				...
				this.func_225632_a_(matrixStackIn, bufferIn, packedLightIn, entitylivingbaseIn, f, f1, f2,
						partialTicks);
				matrixStackIn.pop();
			}
