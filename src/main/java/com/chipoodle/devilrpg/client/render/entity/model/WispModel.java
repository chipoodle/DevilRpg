...
@OnlyIn(Dist.CLIENT)
public class WispModel<T extends WispEntity> extends SegmentedModel<T> {
	...
	public Iterable<ModelRenderer> getParts() {
		return ImmutableList.of(this.body, this.wingLeft, this.wingRight, this.tail, this.head, this.legLeft,
				this.legRight);
	}

	public void render(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
			float headPitch) {
		this.setRotationAngles(getParrotState(entityIn), entityIn.ticksExisted, limbSwing, limbSwingAmount, ageInTicks,
	...
	public void renderOnShoulder(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn,
			int packedOverlayIn, float p_228284_5_, float p_228284_6_, float p_228284_7_, float p_228284_8_,
			int p_228284_9_) {
		this.setLivingAnimations(WispModel.State.ON_SHOULDER);
		this.setRotationAngles(WispModel.State.ON_SHOULDER, p_228284_9_, p_228284_5_, p_228284_6_, 0.0F, p_228284_7_,
				p_228284_8_);
	...
	private void setRotationAngles(WispModel.State p_217162_1_, int p_217162_2_, float p_217162_3_, float p_217162_4_,
			float p_217162_5_, float p_217162_6_, float p_217162_7_) {
	...
	private void setLivingAnimations(WispModel.State p_217160_1_) {
	...
	private static WispModel.State getParrotState(WispEntity p_217158_0_) {
		if (p_217158_0_.isSitting()) {
			return WispModel.State.SITTING;
		} else {
			return p_217158_0_.isFlying() ? WispModel.State.FLYING : WispModel.State.STANDING;
		}
	}
