...
@OnlyIn(Dist.CLIENT)
public class VineFleshBallRenderer extends EntityRenderer<VineFleshPuppetSeedBall> {
    private static final ResourceLocation ICE_TEXTURES = ResourceLocation.fromNamespaceAndPath(
            DevilRpg.MODID, "textures/entity/vinefleshball/lichenseedball_green.png");
    private final SkullModel model;

    public VineFleshBallRenderer(EntityRendererProvider.Context p_174449_) {
        super(p_174449_);
    ...
    public void render(VineFleshPuppetSeedBall p_116484_, float p_116485_, float p_116486_, PoseStack p_116487_, MultiBufferSource p_116488_, int p_116489_) {
        p_116487_.pushPose();
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull VineFleshPuppetSeedBall p_116482_) {
        return ICE_TEXTURES;
    }
