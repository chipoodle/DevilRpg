...
public class SoulBearModel<T extends SoulBear> extends QuadrupedModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(DevilRpg.MODID, "soulbear"), "armor");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        CubeListBuilder left_chest = CubeListBuilder.create().texOffs(104, 18).addBox(6.0F, -24.0F, -6.0F, 4.0F, 10.0F, 8.0F);
        partdefinition1.addOrReplaceChild("left_chest", left_chest, PartPose.ZERO);
        CubeListBuilder right_chest = CubeListBuilder.create().texOffs(104, 0).addBox(-6.0F, -24.0F, -6.0F, 4.0F, 10.0F, 8.0F);
        partdefinition1.addOrReplaceChild("right_chest", right_chest, PartPose.ZERO);


        return LayerDefinition.create(meshdefinition, 128, 64);
    }

    public void setupAnim(@NotNull T entity, float p_103430_, float p_103431_, float p_103432_, float p_103433_, float p_103434_) {
