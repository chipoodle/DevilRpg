...
@OnlyIn(Dist.CLIENT)
public class WerewolfArrowLayer<T extends LivingEntity, M extends WerewolfHumanModel<T>> extends WerewolfStuckInBodyLayer<T, M> {
   private final EntityRenderDispatcher dispatcher;

   public WerewolfArrowLayer(EntityRendererProvider.Context p_174465_, LivingEntityRenderer<T, M> p_174466_) {
      super(p_174466_);
