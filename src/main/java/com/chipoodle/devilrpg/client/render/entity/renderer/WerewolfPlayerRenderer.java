...
@OnlyIn(Dist.CLIENT)
public class WerewolfPlayerRenderer extends LivingEntityRenderer<AbstractClientPlayer, WerewolfHumanModel<AbstractClientPlayer>> {
   public WerewolfPlayerRenderer(EntityRendererProvider.Context p_174557_, boolean p_174558_) {
      super(p_174557_, new WerewolfHumanModel<>(p_174557_.bakeLayer(p_174558_ ? ModelLayers.PLAYER_SLIM : ModelLayers.PLAYER), p_174558_), 0.5F);
   ...
   private void setModelProperties(AbstractClientPlayer p_117819_) {
      WerewolfHumanModel<AbstractClientPlayer> playermodel = this.getModel();
